    ...
    describe('onSubmit', () => {
        describe('when invalid', () => {
            ...
            it('should show product name error message', () => {
                ...
                expect(productContextActions.upsertProduct).not.toHaveBeenCalled();
            });
        ...
        describe('when valid', () => {
            ...
            it('should add product', () => {
                expect(productContextActions.upsertProduct).toHaveBeenCalled();
            });
            ...
            it('should reset the form', () => {
                ...
                expect(productNameField).toHaveValue('');
                expect(countField).toHaveValue(0);
                expect(priceField).toHaveValue(null);
                expect(promotionalPriceField).toHaveValue(null);
            });
        });
    });
});